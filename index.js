...
function sleep(ms) {
  return new Promise(resolve => setTimeout(resolve, ms));
        ...
        console.log(`${chalk.yellow(`Since Script 2022 - 06 - 22`)}`)
        console.log(`${chalk.blue(`[ ${moment().format('YYYY MMMM Do')} ] `)}`) 
        console.log(`${chalk.blue(`[ ${moment().format('HH:mm:ss')} ] `)}`) 
...
${chalk.red(`Kalo Ada Masalah Sc Chat No :`)} ${chalk.yellow(`082239655059`)}
${chalk.blue('======================================')}`));
      await sleep(8000);
